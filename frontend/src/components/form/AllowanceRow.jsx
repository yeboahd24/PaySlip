  ...
  return (
    <div className="flex items-center gap-2">
      <input
        ...
        className="flex-1 min-w-0 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-ghana-green focus:border-ghana-green outline-none"
      />
      <input
        type="number"
        min="0"
        ...
        className="w-28 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-ghana-green focus:border-ghana-green outline-none"
      />
